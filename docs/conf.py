...
project = 'gordon-introspection'
copyright = '2018, Spotify AB'
author = ('Danielle Malament, Matt Obarzanek, Lynn Root, Amy Skinner, '
          'Steven Stone, James Wen')
...
release = find_version('../src/gordon_introspection/__init__.py')
...
htmlhelp_basename = 'gordonintrospectiondoc'
...
man_pages = [
    (master_doc, 'gordon-introspection', u'gordon-introspection Documentation',
     [author], 1)
]
